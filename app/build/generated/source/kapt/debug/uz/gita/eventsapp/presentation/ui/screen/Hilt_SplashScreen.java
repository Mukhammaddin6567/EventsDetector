 ...
 */
public abstract class Hilt_SplashScreen extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SplashScreen(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SplashScreen_GeneratedInjector) this.generatedComponent()).injectSplashScreen(UnsafeCasts.<SplashScreen>unsafeCast(this));
    }
  }
