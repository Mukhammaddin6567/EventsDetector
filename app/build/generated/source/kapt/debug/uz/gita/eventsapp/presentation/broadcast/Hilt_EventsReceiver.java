  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((EventsReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectEventsReceiver(UnsafeCasts.<EventsReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
