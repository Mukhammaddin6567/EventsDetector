 ...
 */
public abstract class Hilt_EventsScreen extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EventsScreen(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EventsScreen_GeneratedInjector) this.generatedComponent()).injectEventsScreen(UnsafeCasts.<EventsScreen>unsafeCast(this));
    }
  }
